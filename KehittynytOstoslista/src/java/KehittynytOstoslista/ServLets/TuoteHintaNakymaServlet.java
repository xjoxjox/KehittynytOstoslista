 ...
 * @author Johanna
 */
public class TuoteHintaNakymaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("hinnanpaivitysTuote", tuote);
        request.setAttribute("hinnanpaivitys", "hinnanpaivitys");
        ...
        for (Kauppa kauppa:kaupat) {
            System.out.println(kauppa.getNimi());
        }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(TuoteHintaNakymaServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
